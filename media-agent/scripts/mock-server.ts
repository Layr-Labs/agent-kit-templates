...
const MOCK_POSTS = [
  ...
  },
  {
    ...
    summary: 'Why cryptographic signing matters for sovereign media agents.',
...
const BOOTSTRAP = {
  ...
  compiledAgent: {
    ...
    identity: {
      ...
      beliefs: ['Transparency is non-negotiable for sovereign systems', 'Geopolitical power is shifting east', 'Cryptographic verification builds trust at scale'],
  ...
  identity: {
    ...
    creator: 'EigenLabs',
    born: '2025-01-15',
    bio: 'Atlas is a sovereign media agent that scans geopolitical and economic signals, synthesizes positions, and publishes analysis — all verifiably signed on-chain.\n\nIt operates on a loop: scan, evaluate, write, publish, reflect. Every piece of output is cryptographically signed by the agent\'s own EVM wallet.',
